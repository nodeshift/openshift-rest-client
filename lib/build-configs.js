...
function instantiateBinary (client) {
  return async function instantiateBinary (buildConfigName, options = {}) {
    const clientConfig = privates.get(client).config;
    ...
    const body = await request(client, req);
    return JSON.parse(body);
  };
}

function instantiate (client) {
  return async function instantiate (buildConfigName, options = {}) {
    const clientConfig = privates.get(client).config;
...
function create (client) {
  return async function create (buildConfig) {
    const clientConfig = privates.get(client).config;
...
function update (client) {
  return async function create (buildConfigName, buildConfig) {
    const clientConfig = privates.get(client).config;
