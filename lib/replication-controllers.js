...
function findAll (client) {
  return function findAll (options = {}) {
    ...
    const req = {
      method: 'GET',
      url: `${client.kubeUrl}/namespaces/${namespace}/replicationcontrollers`,
      qs: options.qs
    };
...
function find (client) {
  return function find (replicationControllerName, options = {}) {
    ...
    const req = {
      method: 'GET',
      url: `${client.kubeUrl}/namespaces/${namespace}/replicationcontrollers/${replicationControllerName}`
    };
