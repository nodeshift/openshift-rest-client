...
function find (client) {
  return function find (replicationControllerName) {
    const clientConfig = privates.get(client).config;
...
function create (client) {
  return async function create (replicationController) {
    const clientConfig = privates.get(client).config;
...
function update (client) {
  return async function create (replicationControllerName, replicationController) {
    const clientConfig = privates.get(client).config;
