...
const { Client, KubeConfig, alias } = require('kubernetes-client');
 ...
 *
 * If you want to use a username/password combo to authenticate to Openshift,
 * you might do something like the example.
 *
 * @example
 *
 * settings.config = {
 ...
 * };
 *
 * @param {Object} settings kubernetes configuration
